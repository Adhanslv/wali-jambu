		...
		<div className="grid grid-cols-3 gap-10 bg-[#3434eb] text-white  px-[5vw] py-12">
			...
			<div className="col-span-3 md:col-span-1">
				...
				<div className="flex flex-col gap-3">
					<Link
						href={
							"https://mail.google.com/mail/u/0/#inbox?compose=CllgCJNqtVWztkDlcSTDxpBHSbGsQQJmWNDlFMJGXkFXCNknGWFbQQqHKkXjsZQtsRqcvDgGgtg"
						}
						className="flex gap-x-2 items-center"
					>
						<IconMail />
						mohmuslihwalijambu233
					</Link>
					<Link href={"https://wa.me/+6281348111233"} className="flex gap-x-2 items-center">
						<IconBrandWhatsapp />
						+6281348111233
					</Link>
					<Link href={"https://www.facebook.com/moh.muslih.9"} className="flex gap-x-2 items-center">
						<IconBrandMeta />
						Moh Muslih
					</Link>
				</div>
